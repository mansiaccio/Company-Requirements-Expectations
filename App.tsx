...
// Icons (simple SVG components for better control)
...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen pb-20">
      {/* Header */}
      <header className="bg-indigo-700 text-white py-12 px-4 shadow-lg mb-10">
      ...
      <main className="max-w-6xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <section className="lg:col-span-8">
          {!report && !isLoading && (
            <div className="bg-slate-100 border-2 border-dashed border-slate-300 rounded-xl h-96 flex flex-col items-center justify-center text-slate-400 p-10 text-center">
          ...
          {report && (
            <div className="space-y-8">
                      ...
                      <ul className="space-y-2">
                        {report.jdBreakdown.toolsActuallyUsed.map((tool, i) => (
                          <li key={i} className="text-slate-700 text-sm flex items-center gap-2">
                            <span className="text-green-600">✓</span> {tool}
                          </li>
                        ))}
                      </ul>
                    </div>
              ...
              {/* Rejection Analyzer */}
              <div className="bg-rose-50 border border-rose-200 rounded-xl shadow-md overflow-hidden">
      ...
      <footer className="text-center py-10 text-slate-400 text-sm border-t border-slate-200 mt-20">
